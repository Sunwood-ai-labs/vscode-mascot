...
#### ver 3.2.3 (2026/01/05)
    ...
    1. 顶部小宠物默认为关闭状态
    2. 增加小宠物MOD（皮卡丘、恐龍）及留言

#### ver 1.1.1 (2026/01/08)

    1. 拡張機能の有効化プロセスを安定化（「コマンドが見つからない」エラーの修正）
    2. キャラクター変更時の再起動プロンプトが表示されない問題を修正
    3. パッチ適用ロジックの改善と診断ログの追加
    4. セレクションリストに不足していたキャラクター（Deno2, Morph）を追加
    5. リソース同梱の確認を強化